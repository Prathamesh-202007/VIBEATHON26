...
import vibeathonItLogo from "@/assets/vibeathon-it-logo.png";
...
export default function Hero() {
  return (
    <section
      id="top"
      className="relative min-h-[102svh] overflow-hidden bg-cinematic"
    >
      <img
        src={heroImage}
      ...
      <div className="relative z-10 mx-auto flex min-h-[102svh] max-w-7xl flex-col justify-center px-5 pb-24 pt-28 md:px-8 md:pt-36">
        ...
        <div className="flex items-center justify-between gap-6">
          <img
            src={vibeathonItLogo}
            alt="A.C. Patil College of Engineering - Department of Information Technology"
            className="reveal-up h-16 w-auto object-contain md:h-20"
            data-reveal
          />

          <p
            className="reveal-up text-xs font-extrabold uppercase tracking-[0.18em] text-foreground md:text-sm"
            data-reveal
          >
            10 OCT 2026
          </p>
        ...
        <div className="mt-10 text-center md:mt-14">
          ...
          <p
            className="reveal-up mt-6 text-[0.7rem] font-extrabold uppercase tracking-[0.42em] text-muted-foreground md:text-sm"
            data-reveal
          >
            THINK. BUILD. EVOLVE.
          </p>
          ...
          >
            <Button asChild variant="cinematic" size="xl">
              <a
                href="https://unstop.com/o/dcjKCLm"
                onClick={(event) => scrollToId(event, "register")}
              >
                REGISTER NOW →
              </a>
            </Button>
          ...
          <p
            className="reveal-up mt-10 text-xs font-extrabold uppercase tracking-[0.3em] text-foreground md:text-sm"
            data-reveal
          >
            08:00 AM – 08:00 PM
          </p>
